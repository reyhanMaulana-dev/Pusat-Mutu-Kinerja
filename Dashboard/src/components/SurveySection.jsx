            ...
            <div className="block flex flex-col h-full bg-[#0D1730] rounded-xl p-6 border border-accent3/20 hover:border-accent2/50 shadow-md shadow-accent3/10 transition">
              ...
              <div className="mt-auto flex flex-col space-y-2">
                <button
                  ...
                  className="inline-block text-accent2 hover:text-accent1 font-medium transition"
                >
                  Lihat Dashboard →
                </button>
                {survey.gform && (
                  <button
                    onClick={() => handleFillSurvey(survey.gform)}
                    className="inline-block text-accent1 hover:text-accent2 font-medium transition"
                  >
                    Isi Survei →
                  </button>
                )}
